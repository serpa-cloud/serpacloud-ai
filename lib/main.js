...
function createWindow() {
  const win = new BrowserWindow({
    ...
    webPreferences: {
      ...
      webSecurity: false,
      webviewTag: true, // Habilitar el uso de <webview>
      devTools: true, // Habilitar las herramientas de desarrollo
    },
  });
  ...
  // win.loadURL('http://localhost:3000/app/projects/AIProject:7a4e93b5-ce10-4833-939a-ea2cc56a7e15');
}
